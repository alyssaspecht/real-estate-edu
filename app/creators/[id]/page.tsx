        ...
        <div className="max-w-5xl mx-auto px-8 py-12">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-3xl font-bold text-foreground">{creator.name ?? 'Creator'}</h1>
              {creator.profile?.headline && (
                <p className="text-lg text-muted-foreground mt-1">{creator.profile.headline}</p>
              )}
              {creator.profile?.bio && (
                <p className="text-muted-foreground mt-3 leading-relaxed max-w-2xl">{creator.profile.bio}</p>
              )}
      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        {creator.createdCourses.length === 0 ? (
          <div className="glass-card rounded-2xl p-12 text-center">
            ...
            <p className="text-muted-foreground">{firstName} hasn't published any courses yet.</p>
          </div>
        ) : (
            ...
            {creator.createdCourses.map((course) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="font-semibold text-foreground mt-1 line-clamp-2 leading-snug">
                    {course.title}
                  </h3>
