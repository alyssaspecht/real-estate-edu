          ...
          <div className="flex-1">
            ...
            {details.bio && (
              <div className="mb-2">
                ...
                <p className="text-sm text-foreground mt-0.5">{details.bio}</p>
              </div>
            )}
            {details.experience && (
              <div className="mb-2">
                <p className="text-xs font-medium text-muted-foreground uppercase">Experience</p>
                <p className="text-sm text-foreground mt-0.5">{details.experience} years</p>
              </div>
            )}
            {details.topics && (
              <div className="mb-2">
                <p className="text-xs font-medium text-muted-foreground uppercase">Topics</p>
                <p className="text-sm text-foreground mt-0.5">{details.topics}</p>
              </div>
            )}
